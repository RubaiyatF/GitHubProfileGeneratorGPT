    ...
    const fetchStarCount = async (): Promise<void> => {
      try {
        const response = await fetch(
          "https://api.github.com/repos/b0ney-1/Castle.ai"
        );
        ...
        <div className="flex justify-between items-start">
          ...
          <div style={{ pointerEvents: "auto" as const }}>
            ...
            <div className="text-black dark:text-white mb-2 text-2xl font-bold font-sans relative z-[1]">
              Build your own GitHub Profile Generator
            </div>
            <div className="flex items-center gap-4 relative z-[1]">
              ...
              <div className="relative inline-flex items-center group">
                <button className="flex items-center gap-2 px-4 py-2 rounded-md border border-gray-200 bg-black text-white hover:bg-white hover:text-black transition-colors text-xs">
                  ...
                  <p className="font-sans text-white group-hover:text-black">
                    Star
                  </p>
                </button>
            ...
            <div className="flex items-center gap-2 pt-8">
              ...
              <div className="flex items-center">
                <Image
                  ...
                  height={20}
                />
                <span className="text-black dark:text-white text-xl font-semibold ml-2 leading-none font-sans">
                  metaschool
                </span>
              </div>
            </div>
            <div className="flex items-center">
              <span className="mr-4 text-gray-600 pt-4 font-sans">
                Follow us on
              </span>
